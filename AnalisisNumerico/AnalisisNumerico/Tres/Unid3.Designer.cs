namespace AnalisisNumerico.Tres
{
    partial class Unid3
    {
		...
		private void InitializeComponent()
		{
			...
			// panelPuntos
			// 
			panelPuntos.BackColor = SystemColors.ButtonFace;
			...
			panel11.Controls.Add(lblMetodo);
			panel11.Location = new Point(231, 94);
			panel11.Name = "panel11";
			panel11.Size = new Size(217, 46);
			panel11.TabIndex = 28;
			// 
			// panel12
			// 
			panel12.BackColor = Color.Wheat;
			panel12.Location = new Point(8, 0);
			panel12.Name = "panel12";
			panel12.Size = new Size(11, 75);
			panel12.TabIndex = 0;
			// 
			// label11
			// 
			...
			lblMetodo.Location = new Point(86, 13);
			lblMetodo.Name = "lblMetodo";
			lblMetodo.Size = new Size(43, 17);
			lblMetodo.TabIndex = 6;
			lblMetodo.Text = "label2";
			// 
			// panel9
			// 
			...
			lblEfectividad.Font = new Font("Britannic Bold", 12F, FontStyle.Regular, GraphicsUnit.Point);
			lblEfectividad.Location = new Point(136, 13);
			lblEfectividad.Name = "lblEfectividad";
			lblEfectividad.Size = new Size(51, 17);
			...
			panel7.Location = new Point(231, 42);
			panel7.Name = "panel7";
			...
			lblcorrelacion.Font = new Font("Britannic Bold", 12F, FontStyle.Regular, GraphicsUnit.Point);
			lblcorrelacion.Location = new Point(151, 10);
			lblcorrelacion.Name = "lblcorrelacion";
			lblcorrelacion.Size = new Size(51, 17);
			...
			lblfuncion.Location = new Point(136, 13);
			lblfuncion.Name = "lblfuncion";
			lblfuncion.Size = new Size(51, 17);
